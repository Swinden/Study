...
# data_matrix = np.loadtxt(r'room1\room1_data\room1_twodoors', dtype=float)
...
class Agent(object):
    ...
    def f_ik_wall(self, wall):  # interaction with the wall in the room
        ...
        # Assume wall and people give same force
...
def main():
    ...
    walls = [[room_left, room_top, \
        room_left + room_width, room_top],
            [room_left, room_top, \
                room_left, door_ytop],
            [room_left, room_top+room_height, \
                room_left, door_ybottom],
            [room_left, room_top+room_height, \
                room_left + room_width, room_top + room_height],
            [room_left + room_width, room_top, \
                room_left + room_width, door_ytop],
            [room_left+room_width, room_top + room_height, \
                room_left + room_width, door_ybottom]]
    ...
    while run:
        ...
        for wall in walls:
            ...
            end_posx = end_posw
            pygame.draw.line(roomscreen, line_color, \
                start_posx, end_posx, 3)
        ...
        for agent_i in agents:
            ...
            pygame.draw.line(roomscreen, agent_color, \
                start_position, end_positionDV, 2)
        pygame.draw.line(roomscreen, [255, 60, 0], \
            start_position, end_positionDV, 2)
...
main()
np.savetxt(r'room1\room1_data\room1_twodoors', data_matrix)
